...
Found 1 error in 1 file.`,
    output: `------------\\
src/api.ts(42,15):TS2339:'getUserProfileWithSettings'@'VeryLongTypeNameThatExceedsThi...'
------------/ ✗ typecheck: 1 error, 1 file`,
  },
  {
    input: `src/typecheck.ts(74,5): error TS2552: Cannot find name 'onsole'. Did you mean 'console'?`,
    output: `------------\\
src/typecheck.ts(74,5):TS2552:'onsole'~'console'
------------/ ✗ typecheck`,
  },
];
